        ...
        <div class="container">
            <header class="row">
                ...
                <div class="span-mini-12 text-right">
                    <?php echo $necktie_main_menu /* line 14 */ ?>
            ...
            <div class="row">
                <div class="span-large-20 offset-large-2">
                    <div class="row video" id="video">
                        ...
                        <img src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 32 */ ?>/resources/img/video-thumbnail.png" alt="thumbnail">
                        <div class="overlay">
                            <a href="#">
                                <span class="outer">
                                    <span class="inner">
